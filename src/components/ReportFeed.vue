<template>
  <aside class="h-full w-full bg-white dark:bg-slate-900 border-r border-slate-200 dark:border-slate-800 flex flex-col shrink-0 text-slate-800 dark:text-slate-100 select-none transition-colors duration-200">
    ...
    <div class="p-4 border-b border-slate-100 dark:border-slate-800 flex items-center justify-between">
      ...
      <button
        ...
        @click="$emit('close')"
        class="p-1 rounded-lg text-slate-400 hover:text-slate-700 dark:hover:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors cursor-pointer lg:hidden"
      >
    ...
    <!-- Search Input -->
    <div class="p-3 bg-slate-50 dark:bg-slate-850 border-b border-slate-100 dark:border-slate-800">
      <div class="relative">
        <input
          type="text"
          v-model="searchQuery"
    ...
    <div class="flex-1 overflow-y-auto p-4 space-y-3.5">
      ...
      >
        ...
        <!-- Description (Sleek italic quote from Design HTML) -->
    ...
    <!-- Sleek Aside Footer (Matching Design HTML) -->
    <div class="p-4 bg-slate-50 dark:bg-slate-850 border-t border-slate-100 dark:border-slate-800 text-[11px] text-slate-400 dark:text-slate-500">
